...
class CryptoKline {
  ...
  factory CryptoKline.fromJson(Map<String, dynamic> json) => _$CryptoKlineFromJson(json);
  ...
  CryptoKline copyWith({
    ...
    return CryptoKline(
      ...
      takerBuyBaseAssetVolume: takerBuyBaseAssetVolume ?? this.takerBuyBaseAssetVolume,
      takerBuyQuoteAssetVolume: takerBuyQuoteAssetVolume ?? this.takerBuyQuoteAssetVolume,
...
class TechnicalSignals {
  ...
  factory TechnicalSignals.fromJson(Map<String, dynamic> json) => _$TechnicalSignalsFromJson(json);
...
class TechnicalTrends {
  ...
  factory TechnicalTrends.fromJson(Map<String, dynamic> json) => _$TechnicalTrendsFromJson(json);
...
class TechnicalSupportResistance {
  ...
  factory TechnicalSupportResistance.fromJson(Map<String, dynamic> json) => _$TechnicalSupportResistanceFromJson(json);
