...
class AppConfig {
  ...
  static const String appDescription =
      'Comprehensive Crypto Analysis and Notification Application';
  ...
  static String get currentBaseUrl {
    ...
    // For debug builds, you can switch between dev and local
    return baseUrl;
  }

  // Firebase Configuration
  static const String firebaseApiKey =
      'AIzaSyBMendfBjnBRqxzV9bB--qVvQv3lg-VQMs';
  ...
  static const String firebaseStorageBucket =
      'btcbaran-c7334.firebasestorage.app';
  ...
  // Security Settings (already defined above)
}
