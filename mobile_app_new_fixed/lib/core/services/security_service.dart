...
class SecurityService {
  ...
  static Future<void> initialize() async {
    try {
      Logger.info('Initializing SecurityService...', 'SecurityService');
      // Initialize security services
      await _checkBiometricAvailability();
      Logger.info(
          'SecurityService initialized successfully', 'SecurityService');
    } catch (e, st) {
      Logger.error(
          'Error initializing SecurityService: $e', 'SecurityService', e, st);
      // Don't rethrow - security service is not critical for app startup
    }
  }
  ...
  static Future<List<SecurityRecommendation>>
